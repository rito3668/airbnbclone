  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
        ...
        <div className='flex items-center md:border-2 md:shadow-sm rounded-full py-2'>
            <input type="text" placeholder={placeholder||'Explore thousands of places...'} className='pl-5 bg-transparent outline-none flex-grow text-sm text-gray-600 placeholder-gray-400' value={searchInput} onChange={(e)=>setSearchInput(e.target.value)}/>
        ...
        {searchInput &&(
            <div className='flex flex-col col-span-3 mx-auto mt-2'>
                ...
                <div className='flex items-center border-b mb-4'>
                    ...
                    <input type="number" className='w-12 pl-2 text-lg outline-none text-red-400' value={noOfGuests} onChange={(e)=>setNoOfGuests(e.target.value)}  min={1}/>
                </div>
                <div className='flex'>
